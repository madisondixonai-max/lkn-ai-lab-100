...
export const PRIMARY_BUTTON = "bg-purple-600 text-white hover:bg-purple-700 transition";
export const CARD_STYLE = "bg-purple-50 border border-purple-300 rounded-xl";
