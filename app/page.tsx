...
// ===============================
// v3.0.0 — AI Content Engine (dynamic inputs + guards)
// ===============================
...
export default function Home() {
 ...
 const [error, setError] = useState<string | null>(null); // Error modal
  // User inputs
 const [platform, setPlatform] = useState("TikTok");
 const [topic, setTopic] = useState("");
 const [style, setStyle] = useState("Storytelling");
 const [length, setLength] = useState("1–2 sentences");
  const userId = "755db8bc-8cd7-46c2-b93e-1804478ef012";


 // Map length options to AI instructions
